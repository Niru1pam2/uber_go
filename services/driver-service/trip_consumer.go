...
func (c *tripConsumer) handleFindAndNotifyDrivers(ctx context.Context, payload messaging.TripEventData) error {
	...
	log.Printf("Found suitable drivers %v", payload.Trip.SelectedFare.PackageSlug)
	...
	if len(suitableIDs) == 0 {
		// Notify the rider no drivers are avialable
	...
	// Notify the driver about a ppotential trip
